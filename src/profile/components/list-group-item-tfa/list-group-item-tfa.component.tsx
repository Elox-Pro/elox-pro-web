...
import UpdateTfaModal from "../update-tfa-modal/update-tfa-modal.component";

export default function ListGroupItemTfa() {
    ...
    return (<>
        ...
        <UpdateTfaModal show={showModal} onHide={onHide} />
    </>
    )
}